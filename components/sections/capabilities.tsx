...
export function Capabilities() {
  ...
  return (
    <section className="max-w-[1200px] mx-auto px-6 md:px-12 py-16 relative overflow-visible" id="capabilities">
      <div className="absolute -top-[200px] -left-[200px] w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(139,92,246,0.04)_0%,rgba(6,182,212,0.02)_40%,transparent_70%)] rounded-full blur-[80px] animate-[drift_25s_ease-in-out_infinite] pointer-events-none z-0" />
