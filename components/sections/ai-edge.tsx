...
export function AIEdge() {
  return (
    <section className="max-w-[1200px] mx-auto px-6 md:px-12 py-24 relative">
      <SectionHeader
      ...
      <ScrollReveal>
        <div className="max-w-[680px] mx-auto text-center mb-16">
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            ...
            We live on the bleeding edge so you can focus on running your business.
          </p>
        </div>
      </ScrollReveal>
        ...
        {pillars.map((p, i) => {
          ...
          return (
            <ScrollReveal key={i} delay={i * 0.08}>
              <div className="group rounded-xl border border-dashed border-ag-line bg-ag-surface p-7 h-full transition-colors hover:border-brand/20">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-base font-medium text-foreground mb-1.5">{p.title}</h3>
