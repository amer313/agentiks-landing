...
export function MacbookScroll({
  ...
  const scaleX = useTransform(scrollYProgress, [0, 0.3], [1.2, isMobile ? 1 : 1.15])
  const scaleY = useTransform(scrollYProgress, [0, 0.3], [0.6, isMobile ? 1 : 1.15])
  const translate = useTransform(scrollYProgress, [0, 1], [0, 400])
  const rotate = useTransform(scrollYProgress, [0.1, 0.12, 0.3], [-28, -28, 0])
  const textTransform = useTransform(scrollYProgress, [0, 0.3], [0, 100])
  const textOpacity = useTransform(scrollYProgress, [0, 0.2], [1, 0])
  const screenFadeOut = useTransform(scrollYProgress, [0.5, 1], [1, 0])

  return (
    <div ref={ref} className="min-h-[250vh] flex flex-col items-center py-0 md:py-20 justify-start shrink-0 [perspective:800px] md:scale-100 scale-[0.35] sm:scale-50">
      <motion.h2 style={{ translateY: textTransform, opacity: textOpacity }} className="text-white text-3xl md:text-5xl font-medium mb-20 text-center tracking-tight">
        {title}
      </motion.h2>
      ...
      <div className="h-[22rem] w-[32rem] bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        ...
        <div className="flex relative">
          <div className="mx-auto w-[10%] overflow-hidden h-full"><SpeakerGrid /></div>
          <div className="mx-auto w-[80%] h-full"><Keypad /></div>
          <div className="mx-auto w-[10%] overflow-hidden h-full"><SpeakerGrid /></div>
        </div>
        <Trackpad />
...
function Lid({ scaleX, scaleY, rotate, translate, screenFadeOut, children }: {
  scaleX: MotionValue<number>; scaleY: MotionValue<number>; rotate: MotionValue<number>
  translate: MotionValue<number>; screenFadeOut: MotionValue<number>; children: React.ReactNode
}) {
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        <div style={{ boxShadow: "0px 2px 0px 2px #171717 inset" }} className="absolute inset-0 bg-[#010101] rounded-lg flex items-center justify-center" />
      </div>
      {/* Screen (animated) */}
      <motion.div
        style={{ scaleX, scaleY, rotateX: rotate, translateY: translate, opacity: screenFadeOut, transformStyle: "preserve-3d", transformOrigin: "top" }}
        className="h-96 w-[32rem] absolute inset-0 bg-[#010101] rounded-2xl p-2"
      >
        <div className="absolute inset-0 bg-[#272729] rounded-lg" />
        <div className="absolute inset-[2px] rounded-lg overflow-hidden bg-[#0a0a0c]">
          {children}
        </div>
      </motion.div>
    </div>
...
function Trackpad() {
  return <div className="w-[40%] mx-auto h-32 rounded-xl my-1" style={{ boxShadow: "0px 0px 1px 1px #00000020 inset" }} />
}
...
function Keypad() {
  return (
    <div className="h-full rounded-md bg-[#050505] mx-1 p-1">
      ...
      <Row>
        <KBtn childrenClassName="h-full justify-between py-[4px]"><div className="flex justify-end w-full pr-1"><span className="block">fn</span></div><div className="flex justify-start w-full pl-1"><IconWorld className="h-[6px] w-[6px]" /></div></KBtn>
        <KBtn childrenClassName="h-full justify-between py-[4px]"><div className="flex justify-end w-full pr-1"><IconChevronUp className="h-[6px] w-[6px]" /></div><div className="flex justify-start w-full pl-1"><span className="block">control</span></div></KBtn>
        <KBtn childrenClassName="h-full justify-between py-[4px]"><div className="flex justify-end w-full pr-1"><OptionKey className="h-[6px] w-[6px]" /></div><div className="flex justify-start w-full pl-1"><span className="block">option</span></div></KBtn>
        <KBtn className="w-8" childrenClassName="h-full justify-between py-[4px]"><div className="flex justify-end w-full pr-1"><IconCommand className="h-[6px] w-[6px]" /></div><div className="flex justify-start w-full pl-1"><span className="block">command</span></div></KBtn>
        <KBtn className="w-[8.2rem]" />
        <KBtn className="w-8" childrenClassName="h-full justify-between py-[4px]"><div className="flex justify-start w-full pl-1"><IconCommand className="h-[6px] w-[6px]" /></div><div className="flex justify-start w-full pl-1"><span className="block">command</span></div></KBtn>
        <KBtn childrenClassName="h-full justify-between py-[4px]"><div className="flex justify-start w-full pl-1"><OptionKey className="h-[6px] w-[6px]" /></div><div className="flex justify-start w-full pl-1"><span className="block">option</span></div></KBtn>
...
function KBtn({ className, children, childrenClassName, backlit = true }: {
  ...
  return (
    <div className={cn("p-[0.5px] rounded-[4px]", backlit && "bg-white/[0.2] shadow-xl shadow-white")}>
      <div className={cn("h-6 w-6 bg-[#0A090D] rounded-[3.5px] flex items-center justify-center", className)} style={{ boxShadow: "0px -0.5px 2px 0 #0D0D0F inset, -0.5px 0px 2px 0 #0D0D0F inset" }}>
...
function SpeakerGrid() {
  return <div className="flex px-[0.5px] gap-[2px] mt-2 h-40" style={{ backgroundImage: "radial-gradient(circle, #08080A 0.5px, transparent 0.5px)", backgroundSize: "3px 3px" }} />
}
