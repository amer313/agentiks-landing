...
export const VisitAgentiksV3: React.FC<PhraseVisualProps> = ({ progress, durationFrames }) => {
  ...
  const underlineWidth = interpolate(urlSpring, [0.2, 1], [0, 100], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
